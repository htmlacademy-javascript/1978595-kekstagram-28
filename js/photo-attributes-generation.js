...
const getPhotoAttributes = () => ({
  ...
  comment: [getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment(),getComment()]
});
